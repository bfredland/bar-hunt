// Bar Scavenger Hunt Application with Enhanced Leaderboard
class ScavengerHuntGame {
    ...
    bindEvents() {
        ...
        // Admin controls
        this.addEventHandler('start-game-btn', 'click', () => this.startGame());
        this.addEventHandler('end-game-btn', 'click', () => this.endGame());
        this.addEventHandler('reset-game-btn', 'click', () => this.resetGame());
        this.addEventHandler('export-results-btn', 'click', () => this.exportResults());

        // Player management
        this.addEventHandler('add-player-btn', 'click', () => this.addPlayer());
        this.addEventHandler('player-name-input', 'keypress', (e) => {
            if (e.key === 'Enter') {
                e.preventDefault();
                this.addPlayer();
            }
        ...
        // Configuration
        this.addEventHandler('toggle-config-btn', 'click', () => this.toggleConfigEditor());
        this.addEventHandler('save-config-btn', 'click', () => this.saveConfiguration());
        this.addEventHandler('reset-config-btn', 'click', () => this.resetConfiguration());

        // Navigation
        this.addEventHandler('view-leaderboard-btn', 'click', () => this.showLeaderboard());
        this.addEventHandler('show-leaderboard-btn', 'click', () => this.showLeaderboard());
        this.addEventHandler('close-leaderboard-btn', 'click', () => this.closeLeaderboard());
        this.addEventHandler('back-to-admin-btn', 'click', () => this.showView('admin-view'));
        this.addEventHandler('switch-player-btn', 'click', () => this.showPlayerSelection());

        // Leaderboard controls
        this.addEventHandler('expand-all-btn', 'click', () => this.expandAllPlayers());
        this.addEventHandler('collapse-all-btn', 'click', () => this.collapseAllPlayers());

        // Modal controls
        this.addEventHandler('close-winner-modal-btn', 'click', () => this.hideWinnerModal());
        this.addEventHandler('start-new-game-btn', 'click', () => this.startNewGame());
        this.addEventHandler('confirm-yes-btn', 'click', () => this.confirmChallenge());
        this.addEventHandler('confirm-no-btn', 'click', () => this.cancelChallenge());
    ...
    addEventHandler(elementId, event, handler) {
        ...
        if (element) {
            ...
            console.log(`Event handler added to ${elementId}`);
        } else {
